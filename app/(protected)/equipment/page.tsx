      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Manage and track all company assets</p>
          </div>
          <Button
            onClick={() => {
        ...
        <div className="flex gap-3">
          ...
          <Button variant="outline" size="icon" className="glass-sm bg-white/5 border-white/20">
